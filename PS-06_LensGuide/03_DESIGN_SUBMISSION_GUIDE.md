...
3. `data/queries/starter_queries.sql` — run them against `data/PS-06.db`. Ten minutes of running real queries will change what you design.
...
```
<TeamName>_PS-06_Design_v1.pdf
<TeamName>_PS-06_Wireframes.pdf
<TeamName>_PS-06_Architecture.drawio
```
...
3. Confirm the problem statement shown is PS-06. If it is not, stop and contact the organisers — do not upload.
